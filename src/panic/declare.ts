...
export enum ERROR_CODE {
    ...
    EXTERNAL_SOURCE_FETCH_FAILED = 1605,
    ...
    SOURCE_EXTERNAL_FILE_NOT_FOUND = 4207,
...
export const ERROR_LIST: Record<ERROR_CODE, string> = {
    ...
    [ERROR_CODE.EXTERNAL_SOURCE_FETCH_FAILED]: 'Failed fetch external source: "{}"',
    ...
    [ERROR_CODE.SOURCE_EXTERNAL_FILE_NOT_FOUND]: 'Source external file: "{}" not found',
    ...
    [ERROR_CODE.FALSE_CORE_CALL]: 'Call core failed',
